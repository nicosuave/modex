...
test(
  'actual HOME normalization retains custom High/Max after optimistic selection clears',
  { skip: !available },
  () => {
    ...
    const original = normalize(bundles[initial]),
      modified = normalize(patched[initial]);
    ...
    function run(fn, effort, settings, home = true) {
      return fn(
        { model: 'gpt-6-astra', reasoningEffort: effort },
        home,
        { data: {} },
        () => stock,
        { models: [] },
