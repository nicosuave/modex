...
export const moduleSets={'theme-icon':['theme-icon-render','theme-icon-runtime'],'model-spread':['model-spread','model-spread-editor'],'task-panes':['task-panes-runtime','task-panes-drag'],'custom-cli':[]};
